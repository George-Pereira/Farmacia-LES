...
<head>
    ...
    <title>Principal - Coronga Farm</title>
    <!-- CSS only -->
        ...
        <main>
            ...
            <nav id="paginacao">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item"><a class="page-link" href="principal.jsp">1</a></li>
                    <li class="page-item active"><a class="page-link" href="principal2.jsp">2</a></li>
                    <li class="page-item"><a class="page-link" href="principal3.jsp">3</a></li>
                    <li class="page-item">
